...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_mode', action='store_true',
                       help='Is it for training dataset?')
    parser.add_argument('--config_path', type=str, default='./dataset_config.json',
    ...
    # Configurar matplotlib cache para evitar permisos
    ...
    if train_mode:
        print("Creating TRAIN/VALIDATION dataset...(processing a proportion of background images)")
        ds.create_train_dataset(class_encoding=config['class_encoding'])
    else:
        print("Creating TEST dataset...(processing all the background images.)")
